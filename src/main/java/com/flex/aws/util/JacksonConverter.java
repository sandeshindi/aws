...
public interface JacksonConverter {
	...
	/**
	 * Converts a list of maps of AttributeValues to a JsonNode instance that
	 * represents the list of maps.
	 *
	 * @param items
	...
	/**
	 * Converts a list of AttributeValues to a JsonNode instance that represents
	 * the list.
	 *
	 * @param list
	...
	/**
	 * Converts a map of AttributeValues to a JsonNode instance that represents
	 * the map.
	 *
	 * @param map
